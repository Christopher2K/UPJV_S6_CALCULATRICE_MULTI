 ...
 */
/**
 * Fenêtre qui apparait lors d'une résolution d'équation simple
 * GUI via src/com.katoyikane/vue/modules/module4_eq_simple.fxml
 */
public class PopUpEqSimple
{
    ...
    public static void afficher() throws Exception
    {
        ...
        root = FXMLLoader.load(PopUpTableau.class.getResource("../modules/module4_eq_simple.fxml"));
